...
- For skill folders / hook scripts: use whatever name makes sense — they live in `agents/{your-company}/` regardless.
...
- AIOS canonical agents at the framework level: `agents/aios-*/` (or relevant location)
