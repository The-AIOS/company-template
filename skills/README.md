...
> Optional company-distributed skills. When an operator runs `/aios:company --sync {your-company}`, the contents of this folder land at `skills/{your-company}/` in their AIOS vault.

## Why distribute skills at the company level?
...
- For skill folders / hook scripts: use whatever name makes sense — they live in `skills/{your-company}/` regardless.

## Empty folder = no shipment

If this folder is empty (just this README), operators who mount {your-company} won't get any skills in their vault. That's fine — most companies don't ship custom skills; context alone is enough.

## See also

- The AIOS `/aios:company` command reference (in [The-AIOS/aios](https://github.com/The-AIOS/aios))
- AIOS canonical skills at the framework level: `skills/aios-*/` (or relevant location)
